/* Added by hand for Visual Studio build */
#define DX_NATIVE_WINDOWS 1
...
/* Define to 1 if errno.h defines sys_errlist */
...
/* Define to 1 if errno.h defines _sys_errlist */
...
#define PACKAGE_STRING "dx 4.2.1"
