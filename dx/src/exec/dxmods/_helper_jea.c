...
/*********************************************************************/
/*
 * $Header: /home/xubuntu/berlios_backup/github/tmp-cvs/opendx2/Repository/dx/src/exec/dxmods/_helper_jea.c,v 1.2 1999/05/03 14:06:29 gda Exp $
 */
                           ...
                           Pointer        delta )
{
    ...
    Category  cat;
    int       rank;
    int       shape [ 8 ]; /* Just in case rank != 1 */
    int       position = Component_Type_pos ( comp_type );
