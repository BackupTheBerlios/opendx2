...
#ifndef	lint
static char *rcsid[] = {"$Header: /home/xubuntu/berlios_backup/github/tmp-cvs/opendx2/Repository/dx/src/exec/hwrender/hwInitScreen.c,v 1.2 1999/05/03 14:06:39 gda Exp $"};
#endif
