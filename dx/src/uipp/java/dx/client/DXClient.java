...
/*
 * $Header: /home/xubuntu/berlios_backup/github/tmp-cvs/opendx2/Repository/dx/src/uipp/java/dx/client/DXClient.java,v 1.1 1999/03/24 15:17:30 gda Exp $
 */
...
public abstract class DXClient extends Applet {
    ...
    protected int getPort() { return 4655; }
	...
	try {
	    ...
	    is = new DataInputStream(dxSocket.getInputStream()); 
