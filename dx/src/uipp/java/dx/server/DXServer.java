...
/*
 * $Header: /home/xubuntu/berlios_backup/github/tmp-cvs/opendx2/Repository/dx/src/uipp/java/dx/server/Attic/DXServer.java,v 1.1 1999/03/24 15:17:33 gda Exp $
 */
import java.net.*;
import java.io.*;
import java.util.*;
...
public class DXServer extends Object {
    ...
    public static String getStartDate() { return started_at.toLocaleString(); }
    public static int getServedCount() { return java_id-1; }

    private static int maxThreads;
    public static int getMaxThreads() { return DXServer.maxThreads; }
    ...
    public static String getOutputUrl() { return output_url; }
...
public synchronized static int getUserCount() { return users.size(); }
