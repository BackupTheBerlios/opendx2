...
/*
 * $Header: /home/xubuntu/berlios_backup/github/tmp-cvs/opendx2/Repository/dx/src/uipp/java/dx/server/Attic/DXThread.java,v 1.1 1999/03/24 15:17:33 gda Exp $
 */
import java.net.*;
import java.io.*;
import java.util.*;
...
public abstract class DXThread extends Thread
{
    ...
    protected boolean isFailed() { return failed; }
...
protected boolean disconnect() { return disconnect(null); }
