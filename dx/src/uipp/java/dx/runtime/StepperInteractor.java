...
package dx.runtime;
/*
 * $Header: /home/xubuntu/berlios_backup/github/tmp-cvs/opendx2/Repository/dx/src/uipp/java/dx/runtime/StepperInteractor.java,v 1.1 1999/03/24 15:17:32 gda Exp $
 */
import java.awt.*;
...
public void reshape (int x, int y, int w, int h)
{
	...
	super.reshape (x,y,w,required_height);
    } else {
