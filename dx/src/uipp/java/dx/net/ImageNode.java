...
/*
 * $Header: /home/xubuntu/berlios_backup/github/tmp-cvs/opendx2/Repository/dx/src/uipp/java/dx/net/ImageNode.java,v 1.3 1999/07/09 19:30:00 daniel Exp $
 */
...
//
    ...
    public void setPalindromeMode(boolean onoroff) { this.palindrome = onoroff; }
    public boolean getPalindromeMode() { return this.palindrome; }
    ...
    public boolean isPerspective() { return this.perspective; }
    ...
    public synchronized int getCacheSpeed () { return this.cache_speed; }
    public synchronized void setCacheSpeed (int speed) { this.cache_speed = speed; }
    ...
    public String getTitle() { return this.getInputValueString (ImageNode.IMAGENAME); }

    public int getInteractionMode() { return this.interaction_mode; }
    ...
    public int getCacheCount() { return this.cache_count; }
    public String getGroupName() { return this.group_name; }
    public void setGroupName(String g) { this.group_name = g; }
