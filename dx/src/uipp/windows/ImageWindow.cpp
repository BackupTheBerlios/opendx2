...
void ImageWindow::wait4GLAcknowledge()
{
 ...
 //   e.xclient.message_type = ((unsigned long) 0); // Undefined atom
...
void ImageWindow::sendClientMessage(unsigned long atom, int num, long  *longs)
{
 //   XEvent e;
 //   if (!this->state.hardwareRenderExists || this->state.hardwareWindow == 0)
	//return;
...
void ImageWindow::sendClientMessage(unsigned long atom, int num, short *shorts)
{
 //   XEvent e;
 //   if (!this->state.hardwareRenderExists || this->state.hardwareWindow == 0)
	//return;
...
void ImageWindow::sendClientMessage(unsigned long atom, int num, char  *chars)
{
 //   XEvent e;
 //   if (!this->state.hardwareRenderExists || this->state.hardwareWindow == 0)
	//return;
...
bool ImageWindow::postSaveImageDialog()
{
	...
	this->saveImageDialog = new SaveImageDialog
	    ((ImageNode*)this->node, this->commandScope);
...
void ImageWindow::getGeometryAlternateNames(char** names, int* count, int max)
{
    int cnt = *count;
