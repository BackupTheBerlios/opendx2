...
SetMacroNameDialog::SetMacroNameDialog(const char *name, Network *n):
    Dialog(name)
{
    this->network = n;
...
SetMacroNameDialog::SetMacroNameDialog(Network *n):
    Dialog("setMacroNameDialog")
{
    this->network = n;
...
void SetMacroNameDialog::createDialog(void)
{
//    Arg arg[10];
