...
//        Pixel           background;     /* bboard background color      */
        int           foreground;     /* bboard normal foreground     */
        int           highlight_foreground;
    }                   bboard;
    ...
    struct
    {
        int           background;
                                        /* i/o tag BG color             */
        int           highlight_background;
                                        /* i/o highlighted tab BG color */
        int           required_background;
                                        /* i/o required tag BG color    */
        int       width;          /* i/o tag height               */
        int       height;         /* i/o tag width                */
...
Tab *StandIn::createOutputTab(int ndx, int width)
{
//    int      i;
//    Position x;
//    int      visible_outputs;
...
Tab *StandIn::createInputTab(int ndx, int width)
{
//    int      i;
//    int      visible_inputs;
//    Position x;
