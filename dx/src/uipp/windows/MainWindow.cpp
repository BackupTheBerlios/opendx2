...
void MainWindow::provideContextHelp()
{
}
...
//
void MainWindow::InitializeOffsets()
{
//Window root;
//unsigned int nkids;
...
void MainWindow::getGeometryNameHierarchy(char* names[], int* count, int max)
{
 //   int cnt = *count;
 //   if (cnt >= (max-1)) return ;
...
void MainWindow::getGeometryAlternateNames(char**, int*, int) { }
