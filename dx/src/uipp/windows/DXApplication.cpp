...
char* DXApplication::ListValuedSettings[] = {
    RECENT_NETS,
    EXPANDED_CATEGORIES,
    NULL
};
...
void DXApplication::postLoadMDFDialog()
{
    if (this->loadMDFDialog == NULL) {
        this->loadMDFDialog = new LoadMDFDialog(this);
    }
