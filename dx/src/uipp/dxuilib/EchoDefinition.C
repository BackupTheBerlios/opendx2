...
/*
 * $Header: /home/xubuntu/berlios_backup/github/tmp-cvs/opendx2/Repository/dx/src/uipp/dxuilib/Attic/EchoDefinition.C,v 1.1 1999/03/24 15:17:40 gda Exp $

 $Log: EchoDefinition.C,v $
 Revision 1.1  1999/03/24 15:17:40  gda
 Initial revision
