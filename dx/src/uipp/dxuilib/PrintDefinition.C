...
/*
 * $Header: /home/xubuntu/berlios_backup/github/tmp-cvs/opendx2/Repository/dx/src/uipp/dxuilib/Attic/PrintDefinition.C,v 1.1 1999/03/24 15:17:44 gda Exp $

 $Log: PrintDefinition.C,v $
 Revision 1.1  1999/03/24 15:17:44  gda
 Initial revision
