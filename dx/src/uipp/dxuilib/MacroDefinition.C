...
/*
 * $Header: /home/xubuntu/berlios_backup/github/tmp-cvs/opendx2/Repository/dx/src/uipp/dxuilib/Attic/MacroDefinition.C,v 1.1 1999/03/24 15:17:43 gda Exp $
 *
 */
...
#endif
		    char *ignore = NULL;
		    FILE *f = Network::OpenNetworkFILE(path, &ignore); 
					...
					boolean asSystemMacro)
{
	...
	*errmsg = NULL;
    ...
    FILE *f = Network::OpenNetworkFILE(netFile, errmsg); 
