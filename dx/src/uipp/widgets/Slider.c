...
/*
 * $Header: /home/xubuntu/berlios_backup/github/tmp-cvs/opendx2/Repository/dx/src/uipp/widgets/Slider.c,v 1.1 1999/03/24 15:17:36 gda Exp $
 */
...
#if defined(hp700) || defined(aviion) || defined(solaris) || defined(sun4) || defined (DXD_WIN) || defined(OS2) || defined(linux86)
